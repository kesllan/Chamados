...
var TicketRepository = {
  ...
  _mapRowToTicket: function(row, headers) {
    ...
    ticket.inep = getVal(self.COLUMNS.COD_INEP_ESCOLA);
    ticket.diasAberto = getVal(self.COLUMNS.DIAS_EM_ABERTO);
    ticket.diasUteis = getVal(self.COLUMNS.DIAS_UTEIS_ABERTO);
